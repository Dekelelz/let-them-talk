...
export function resolveAppearance(name, appearance) {
  ...
  var resolved = {
    ...
    hair_style: app.hair_style || ['short', 'spiky', 'bob', 'ponytail', 'none'][h % 5],
    hair_color: app.hair_color || palette.hair_color,
    eye_style: app.eye_style || DEFAULT_APPEARANCE.eye_style,
    mouth_style: app.mouth_style || DEFAULT_APPEARANCE.mouth_style,
